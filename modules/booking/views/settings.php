...
class View extends \Gcms\View
{
    ...
    public function render()
    {
        ...
        $fieldset->add('checkboxgroups', [
            ...
            'value' => isset(self::$cfg->booking_delete) && is_array(self::$cfg->booking_delete) ? self::$cfg->booking_delete : [3]
        ]);
        $fieldset = $form->add('fieldset', [
            'id' => 'verfied',
        ...
        $fieldset->add('select', [
            ...
            'options' => $booleans,
            'value' => self::$cfg->booking_send_mail
        ]);
        // booking_line_id
        $fieldset->add('select', [
            'id' => 'booking_line_id',
            ...
            'options' => [0 => $booleans[0]]+\Index\Linegroup\Model::create()->toSelect(),
            'value' => self::$cfg->booking_line_id
        ]);
        $fieldset = $form->add('fieldset', [
            'class' => 'submit'
        ]);
